...
syn keyword sqlKeyword	index initial into is join left level loop maxextents mode modify
syn keyword sqlKeyword	nocompress nowait of offline on online outer start
...
syn keyword sqlKeyword	public resource return right row rowlabel rownum rows
...
syn keyword sqlType	boolean char character date decimal float integer long
...
" Todo.
syn keyword sqlTodo TODO FIXME DEBUG NOTE
